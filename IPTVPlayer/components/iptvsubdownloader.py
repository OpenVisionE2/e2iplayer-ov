    ...
    if screenwidth and screenwidth == 1920:
        skin = """
                    <screen name="IPTVSubDownloaderWidget" position="center,center" size="1590,825" title="E2iPlayer v%s">
                            ...
                            <widget name="statustext" position="15,148" zPosition="1" size="1580,180" font="Regular;30" horizontalAlignment="center" verticalAlignment="center" transparent="1" backgroundColor="#00000000" />
        ...
        skin = """
                    <screen name="IPTVSubDownloaderWidget" position="center,center" size="1090,525" title="E2iPlayer v%s">
                            ...
                            <widget name="statustext" position="5,140" zPosition="1" size="1080,180" font="Regular;20" horizontalAlignment="center" verticalAlignment="center" transparent="1" backgroundColor="#00000000" />
