...
class IPTVSubSimpleDownloaderWidget(Screen):
    ...
    skin = """
        <screen name="IPTVSubSimpleDownloaderWidget" position="center,center" title="%s" size="%d,%d">
         ...
         <widget name="label_red"     position="45,9"  size="175,27" zPosition="5" verticalAlignment="center" horizontalAlignment="left" backgroundColor="black" font="Regular;21" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" />
         <widget name="label_green"   position="395,9" size="175,27" zPosition="5" verticalAlignment="center" horizontalAlignment="left" backgroundColor="black" font="Regular;21" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" />
